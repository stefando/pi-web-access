...
| `workflow` | `none` (skip curator; default for Brave), `summary-review` (open curator and auto-generate a summary draft; default otherwise), or `auto-summary` (generate a summary without opening the curator) |
